  ...
  return (
    <>
      <motion.div
        ...
        className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 fixed top-0 left-0 right-0 z-20 backdrop-blur-sm font-medium bg-white/50 dark:bg-transparent will-change-transform'>
