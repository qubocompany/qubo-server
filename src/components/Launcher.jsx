        ...
        <div className="fixed inset-0 z-[9999] bg-white dark:bg-black flex flex-col items-center justify-center overflow-hidden">
            ...
            >
                <motion.div
                    ...
                    className="w-24 h-24 mx-auto mb-8 bg-gradient-to-tr from-[#32009E] to-[#8200FF] rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/40"
                >
                ...
                <div className="w-64 h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full mx-auto overflow-hidden ring-1 ring-gray-200 dark:ring-gray-700">
                    <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-[#32009E] via-[#8200FF] to-[#32009E] animate-shimmer bg-[length:200%_100%]"
                    />
                </div>
